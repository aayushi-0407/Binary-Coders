...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageButton sendButton;
    private EditText msgInput;
    private OpenAIChat openAIChat;  // Use the OpenAIChat class
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        openAIChat = new OpenAIChat(this);  // Initialize OpenAIChat instance
    ...
    private void getReply(String message) {
        openAIChat.getResponse(message, new OpenAIChat.VolleyResponseListener() {
            @Override
            public void onError(String message) {
                Log.d("REQUEST ERROR", message);
            }
